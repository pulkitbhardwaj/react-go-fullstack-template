...
import { Component, ReactNode, useReducer } from "react";
...
type PortalReducer = (state: PortalState, action: PortalAction) => PortalState;
...
function usePortal(config: PortalConfig) {
