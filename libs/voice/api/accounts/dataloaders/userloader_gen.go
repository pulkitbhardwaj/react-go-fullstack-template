...
func (l *UserLoader) Load(key string) (*entities.User, error) {
...
func (l *UserLoader) LoadThunk(key string) func() (*entities.User, error) {
	l.mu.Lock()
...
func (l *UserLoader) LoadAll(keys []string) ([]*entities.User, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserLoader) LoadAllThunk(keys []string) func() ([]*entities.User, []error) {
	results := make([]func() (*entities.User, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *UserLoader) Prime(key string, value *entities.User) bool {
	l.mu.Lock()
	var found bool
...
func (l *UserLoader) unsafeSet(key string, value *entities.User) {
	if l.cache == nil {
